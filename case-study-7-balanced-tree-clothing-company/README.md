...
## Hardest Query
C10 — most common 3-product combination. Required a triple self-join on the same table within each transaction, with strict ascending product ID ordering to eliminate duplicate combinations, then grouping and counting across all 2500 transactions. Result: White Tee Shirt - Mens, Grey Fashion Jacket - Womens, Teal Button Up Shirt - Mens appeared together 352 times.
...
## Tools
PostgreSQL 18 · DB Fiddle · GitHub
