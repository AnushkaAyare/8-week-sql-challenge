...
Pizza Runner delivers pizza "Uber-style." The raw data needed serious cleanup first — inconsistent nulls (`null`, `NaN`, empty strings), mixed units (`"20km"` vs `20`), 

and wrong data types across the orders and delivery tables.
